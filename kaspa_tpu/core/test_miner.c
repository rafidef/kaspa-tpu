...
int mine_range(
    ...
    uint8_t nibbles[64] __attribute__((aligned(32)));
...
#pragma GCC unroll 64
        ...
        /* Compare top 64-bits first (fast rejection) */
        ...
        /* If top 64-bits equal, check full byte by byte */
        int less_or_equal = 1;
        for (int i = 23; i >= 0; i--) {
...
void mine_range_bench(
    ...
    uint8_t zero_target[32] = {0}; // Never triggers
